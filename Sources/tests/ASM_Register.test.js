...
test('Check Register merge pops optimization v1', (t) => {
  ...
  let optimizedBlock = block.optimize();
  t.equal(optimizedBlock.block[0].bytes.toString(), "18", 'returns');
  t.equal(optimizedBlock.block.length, 1, 'returns');
  t.end();
});
...
test('Check Register merge pops optimization v2', (t) => {
  ...
  let optimizedBlock = block.optimize();
  t.equal(optimizedBlock.block[0].bytes.toString(), "11", 'returns');
  t.equal(optimizedBlock.block[2].bytes.toString(), "15", 'returns');
  t.equal(optimizedBlock.block.length, 3, 'returns');
  t.end();
});
...
test('Check Register merge pops optimization v3', (t) => {
  ...
  let optimizedBlock = block.optimize();
  t.equal(optimizedBlock.block.length, 7, 'returns');
  t.end();
});