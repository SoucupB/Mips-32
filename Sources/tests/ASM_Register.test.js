...
test('Check Register merge pops optimization v1', (t) => {
  let block = new RegisterBlock();
  block.push(new Pop('5'))
  block.push(new Pop('6'))
  block.push(new Pop('7'))
  block.run();

  block.optimize();
  t.equal(block.block[0].bytes.toString(), "18", 'returns');
  t.equal(block.block.length, 1, 'returns');
  t.end();
});

test('Check Register merge pops optimization v2', (t) => {
  let block = new RegisterBlock();
  block.push(new Pop('5'))
  block.push(new Pop('6'))
  block.push(new Mov('0', '1', MovTypes.NUMBER_TO_REG))
  block.push(new Pop('7'))
  block.push(new Pop('8'))
  block.run();

  block.optimize();
  t.equal(block.block[0].bytes.toString(), "11", 'returns');
  t.equal(block.block[2].bytes.toString(), "15", 'returns');
  t.equal(block.block.length, 3, 'returns');
  t.end();
});

test('Check Register merge pops optimization v3', (t) => {
  let block = new RegisterBlock();
  block.push(new Pop('5'))
  block.push(new Mov('0', '1', MovTypes.NUMBER_TO_REG))
  block.push(new Pop('6'))
  ...
  block.optimize();
  t.equal(block.block.length, 7, 'returns');
  t.end();
});

test('Check Register merge pops optimization v4', (t) => {
  let block = new RegisterBlock();
  block.push(new Push('5'))
  block.push(new Pop('4'))
  block.push(new Mov('0', '1', MovTypes.NUMBER_TO_REG))
  block.push(new Push('3'))
  block.push(new Pop('4'))
  ...
  block.optimize();
  t.equal(block.block.length, 1, 'returns');
  t.equal((block.block[0] instanceof Mov), true, 'returns');
  t.end();
});
...
test('Check Register merge pops optimization v4', (t) => {
  ...
  block.optimize();
  t.equal(block.block.length, 2, 'returns');
  t.equal(block.block[0].bytes, 4, 'returns');
  t.equal((block.block[0] instanceof Pop), true, 'returns');
  t.equal((block.block[1] instanceof Mov), true, 'returns');
  t.end();
});