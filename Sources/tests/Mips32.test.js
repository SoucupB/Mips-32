...
// test('Code translation print negative number v1', (t) => {
//   const program = new Program(`
//     void main() {
//       int a = 0 - 150000;
//       printNumber(a);
...
//   mips32.run();
//   t.equal(mips32.runner.getRawStdoutBuffer(), '-150000', 'returns true');
//   t.end();
// });

test('Code translation print negative number v2', (t) => {
  const program = new Program(`
    void main() {
      int a = 5;
      int b = 10;
  ...
  console.log(mips32.runner.printPointerBytes(32, 80480))
  // t.equal(mips32.runner.getRawStdoutBuffer(), '-150000', 'returns true');
  t.end();
});