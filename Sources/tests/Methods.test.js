...
test('Check Methods checker with return error v4', (t) => {
  let chomp = Methods.chompDeclaration('void someMethod(int _aaga,int _dafb){int b=5;if(b==0){return b;}}', 0);
  let stack = new StackDeclarations();
...
test('Check Methods checker with return error v5', (t) => {
...
test('Check Methods checker with return error v6', (t) => {
  let chomp = Methods.chompDeclaration(`
  int someMethod(int _aaga, int _dafb) {
    int b = 5;
    if(b == 0) {
      return ;
    }
